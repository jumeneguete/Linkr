...
export default function RePostModal({ modalIsOpen, setModalIsOpen, isLoading, repostPost, error, setError }) {
          ...
          {!error ? 
            <>
              ...
              <ButtonContainer>
                ...
                <RePostModalButton onClick={repostPost} disabled={isLoading}>
